...
docker exec host1 ethtool -K host1-p1-sw1-p1tx off tx off 
docker exec sw1 ethtool -K sw1-p1-host1-p1tx off tx off 
docker exec host2 ip link set host2-p1-host1-p1 promisc on 
docker exec host1 ip link set host1-p1-host2-p1 promisc on 
docker exec host2 ethtool -K host2-p1-host1-p1tx off tx off 
docker exec host1 ethtool -K host1-p1-host2-p1tx off tx off 
